  ...
  const handleAssignTask = async () => {
    ...
    try {
      ...
      if (response && response.data) {
        ...
        // Optionally, you can perform any action after successful assignment
      } else {
        console.error("Invalid response");
      }
    } catch (error) {
      ...
      <Card className="p-4 shadow">
        ...
        <Form>
          ...
          <div className="checkboxes mb-3">
            <Form.Check type="checkbox" label="Theory" />
            <Form.Check type="checkbox" label="Lab" />
            <Form.Check type="checkbox" label="IA1" />
            <Form.Check type="checkbox" label="IA2" />
          </div>
